...
public:
	...
	string HasPlayedDotAGamesWithThisBot( string user, string totalgames,string totalkills, string totaldeaths, string totalbuildkills,string totalwins, string totallosses,string winrate);

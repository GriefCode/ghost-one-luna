...
string CLanguage :: HasPlayedDotAGamesWithThisBot( string user, string totalgames, string totalkills, string totaldeaths,string totalbuildkills,string totalwins,string totallosses,string winrate)
{
	...
	Replace( Out, "$TOTALBUILDKILLS$", totalbuildkills );
	Replace( Out, "$X$", winrate);

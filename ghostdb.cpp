...
uint32_t CGHostDB :: DotAPlayerAdd( uint32_t gameid, uint32_t colour, uint32_t kills, uint32_t deaths, uint32_t buildkills, uint32_t win, uint32_t newcolour)
{
	return 0;
}
...
CCallableDotAPlayerAdd *CGHostDB :: ThreadedDotAPlayerAdd( uint32_t gameid, uint32_t colour, uint32_t kills, uint32_t deaths, uint32_t buildkills, uint32_t win, uint32_t newcolour)
{
	return NULL;
}
...
CDBDotAPlayer :: CDBDotAPlayer( uint32_t nID, uint32_t nGameID, uint32_t nColour, uint32_t nKills, uint32_t nDeaths, uint32_t nBuildKills, uint32_t nWin, uint32_t nNewColour)
{
	m_ID = nID;
	m_GameID = nGameID;
	m_Colour = nColour;
...
CDBDotAPlayerSummary :: CDBDotAPlayerSummary( string nServer, string nName, uint32_t nTotalGames, uint32_t nTotalKills, uint32_t nTotalDeaths, uint32_t nTotalBuildKills,uint32_t nTotalWins, uint32_t nTotalLosses, double nWinRate)
{
	m_Server = nServer;
	m_Name = nName;
	m_TotalGames = nTotalGames;
	...
	m_TotalBuildKills = nTotalBuildKills;

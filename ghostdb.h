...
public:
	...
	virtual uint32_t DotAPlayerAdd( uint32_t gameid, uint32_t colour, uint32_t kills, uint32_t deaths, uint32_t buildkills, uint32_t win, uint32_t newcolour);
	...
	virtual CCallableDotAPlayerAdd *ThreadedDotAPlayerAdd(uint32_t gameid, uint32_t colour, uint32_t kills, uint32_t deaths, uint32_t buildkills, uint32_t win, uint32_t newcolour);
...
protected:
	...
	uint32_t m_Kills;
	uint32_t m_Deaths;
	uint32_t m_BuildKills;
	uint32_t m_Win;
	uint32_t m_NewColour;
	uint32_t m_Result;

public:
	CCallableDotAPlayerAdd( uint32_t nGameID, uint32_t nColour, uint32_t nKills, uint32_t nDeaths, uint32_t nBuildKills, uint32_t nWin, uint32_t nNewColour) : CBaseCallable( ), m_GameID( nGameID ), m_Colour( nColour ), m_Kills( nKills ), m_Deaths( nDeaths ), m_BuildKills( nBuildKills ), m_Win( nWin ),m_NewColour( nNewColour ), m_Result( 0 ) { }
...
public:
	CDBDotAPlayer( );
	CDBDotAPlayer( uint32_t nID, uint32_t nGameID, uint32_t nColour, uint32_t nKills, uint32_t nDeaths, uint32_t nBuildKills, uint32_t nWin,uint32_t nNewColour);
	~CDBDotAPlayer( );
	...
	uint32_t GetBuildKills( )	{ return m_BuildKills; }
	uint32_t GetWin( )	{ return m_Win; }
	...
	void SetBuildKills( uint32_t nBuildKills )		{ m_BuildKills = nBuildKills; }
	void SetWin( uint32_t nWin )	{ m_Win = nWin; }
...
private:
	...
	uint32_t m_TotalBuildKills;		// total number of creep kills
	uint32_t m_TotalWins;			// total number of dota games won
	uint32_t m_TotalLosses;			// total number of dota games lost
	double m_WinRate;	

public:
	CDBDotAPlayerSummary( string nServer, string nName, uint32_t nTotalGames, uint32_t nTotalKills, uint32_t nTotalDeaths, uint32_t nTotalBuildKills,uint32_t nTotalWins, uint32_t nTotalLosses, double nWinRate);
//	CDBDotAPlayerSummary( string nServer, string nName, uint32_t nTotalGames, uint32_t nTotalWins, uint32_t nTotalLosses, uint32_t nTotalKills, uint32_t nTotalDeaths, uint32_t nTotalCreepKills, uint32_t nTotalCreepDenies, uint32_t nTotalAssists, uint32_t nTotalNeutralKills, double nWinsPerGame, double nLossesPerGame, double nKillsPerGame, double nDeathsPerGame, double nCreepKillsPerGame, double nCreepDeniesPerGame, double nAssistsPerGame, double nNeutralKillsPerGame, double nScore, uint32_t nTotalTowerKills, uint32_t nTotalRaxKills, uint32_t nTotalCourierKills );
	...
	uint32_t GetTotalBuildKills( )		{ return m_TotalBuildKills; }
